...
#
#  $ bin/test -s bika.qmanager -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src bika.qmanager.testing.BIKA_QMANAGER_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/bika/qmanager/tests/robot/test_example.robot
#
